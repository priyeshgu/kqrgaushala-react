      ...
      <div>
        ...
        <div className=" mb-5 mt-4 row footer-items-row">
          ...
          <div className="col-md-4">
            ...
            <a href='/terms' className='footer-links'> <p>Terms & Conditions</p></a>
            <a href='/refund' className='footer-links'> <p>Refund Policy</p></a>
            <a href='/privacy' className='footer-links'> <p>Privacy Policy</p></a>
